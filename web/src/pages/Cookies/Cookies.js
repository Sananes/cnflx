...
const CookiesIndex = ({ data }) => {
  const { name } = useSiteMetadata();
  return (
    <Layout title={`Cookies Policy | ${name}`}>
      <Page
        ...
        center={true}
      >
        <div className="page-narrow-container">
          <p>
            We use cookies to help improve your experience of&nbsp;
            <a href="https://getconflux.com">https://getconflux.com</a>. This
            cookie policy is part of Conflux's privacy policy, and covers the
            use of cookies between your device and our site. We also provide
            basic information on third-party services we may use, who may also
            use cookies as part of their service, though they are not covered by
            our policy.
          </p>
          <p>
            If you don't wish to accept cookies from us, you should instruct
            your browser to refuse cookies from&nbsp;
            <a href="https://getconflux.com">https://getconflux.com</a>, with
          ...
          <p>
            ...
            they are not covered by Conflux's cookie policy.
          </p>
